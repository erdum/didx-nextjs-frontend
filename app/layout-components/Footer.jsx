...
export default function Footer() {
	return(
		<footer className="w-full flex flex-col bg-neutral-700">
			...
			<div className="w-full min-h-20 flex flex-wrap gap-2 justify-between px-4 py-6 bg-neutral-800 text-neutral-400 lg:px-28 xl:px-30">
				<p>
				...
				<p className="flex gap-x-6 text-xl mt-4 lg:m-0">
					<Link href="https://www.facebook.com/DIDxGlobal"><FontAwesomeIcon icon={faFacebookF}/></Link>
					<Link href="https://twitter.com/didxglobal"><FontAwesomeIcon icon={faTwitter}/></Link>
					<Link href="https://plus.google.com/111382738877008451324"><FontAwesomeIcon icon={faGooglePlusG}/></Link>
					<Link href="https://www.linkedin.com/company/didx"><FontAwesomeIcon icon={faLinkedinIn}/></Link>
					<Link href="https://www.youtube.com/user/didexchange"><FontAwesomeIcon icon={faYoutube}/></Link>
					<Link href="/rss"><FontAwesomeIcon icon={faRss}/></Link>
					<Link href="mailto:care@didx.net"><FontAwesomeIcon icon={faEnvelope}/></Link>
				</p>
			</div>
		</footer>
	)
