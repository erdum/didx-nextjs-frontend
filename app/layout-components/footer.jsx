...
export default function Footer() {
	return(
		<footer className="w-full flex flex-col bg-[#333333]">
			<div className="flex flex-col px-4 py-8 lg:flex-row lg:gap-x-10 lg:px-28 xl:px-80">
			...
			<div className="w-full min-h-20 flex flex-wrap gap-2 justify-between px-4 py-6 bg-[#292929] text-[#ffffff80] lg:px-28 xl:px-80">
				<p>
