...
export default function Header() {
	...
	return (
		<header className="w-full h-20 px-3 flex items-center flex-wrap bg-[#ffffffcc] sticky top-0 z-50 shadow-md lg:h-24 lg:px-8">
			...
			<nav id="mobile-menu" className="w-full h-0 absolute top-20 left-0 flex flex-col items-start justify-start gap-y-6 overflow-hidden font-semibold px-5 text-[#444444] bg-white z-10 transition-all duration-300 ease-in uppercase lg:px-8 xl:px-0 xl:relative xl:top-0 xl:w-auto xl:h-auto xl:gap-x-6 xl:flex-row">
