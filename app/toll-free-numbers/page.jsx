...
import { StandardPage, SmallHeading, Paragraph, Anchor, Table } from '../layout-components/standardPage'

export const metadata = {
	'title': 'DIDX Global Toll Free Coverage | DIDX'
}

const headings = ['S.No', 'Ph.Code', 'Country', 'MRC', 'NRC', 'PPM', 'Channels', 'Channels Expandability', 'Service Restriction', 'Document Restriction']
		...
		<>
			...
			<StandardPage>
				<section className="w-full text-center">
					<Paragraph>
						DIDx is the world's No.1 Direct Inward Dialing numbering (DID Numbers) provider since 2005. We currently have Toll Free numbers from over 100+ countries as part of our coverage.
					</Paragraph>

					<Table headings={headings} values={values} />

					<SmallHeading>
						To get more details about the Service and Document Restrictions with a particular number please contact our sales team.
					</SmallHeading>
				</section>
			</StandardPage>
		</>
