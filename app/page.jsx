    ...
    <main className="w-full">
      ...
      >
        <section className="w-full flex flex-col justify-between items-center gap-y-2 pl-12 pt-12 text-white text-center sm:pl-40 lg:pt-32 lg:gap-y-8 2xl:pt-52 2xl:gap-y-10">
          ...
          <Link
            href="/signup"
            className="self-center mt-6 px-4 py-2 bg-blue-500 text-xl rounded font-semibold transition-colors transition-transform hover:bg-white hover:text-blue-500 hover:scale-110 sm:text-2xl sm:px-6 sm:py-3 sm:mt-8 lg:rounded-lg"
          >
            Sign Up
          </Link>
        </section>
