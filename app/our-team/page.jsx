			...
			<StandardPage>
				<section className="w-full flex flex-wrap justify-evenly gap-y-10 gap-x-2">
					...
					<div className="w-full relative flex flex-col items-center sm:w-2/5 xl:w-1/5">
						...
						<div className="pt-2 text-neutral-300 text-xl flex items-center gap-x-6">
							<Link href="https://www.facebook.com/rehan33"><FontAwesomeIcon icon={faGithub}/></Link>
							<Link href="https://www.facebook.com/rehan33"><FontAwesomeIcon icon={faLinkedinIn}/></Link>
							<Link href="https://www.facebook.com/rehan33"><FontAwesomeIcon icon={faWhatsapp}/></Link>
						</div>
					</div>
