				...
				<section className="w-full flex flex-wrap justify-evenly gap-y-10 gap-x-2">
					<div className="w-full relative flex flex-col items-center sm:w-2/5 xl:w-1/5">
						...
						<div className="pt-2 text-neutral-300 text-xl flex items-center gap-x-6">
							<Link className="hover:cursor-pointer" href="https://www.facebook.com/rehan33"><FontAwesomeIcon icon={faFacebookF}/></Link>
							<Link className="hover:cursor-pointer" href="https://www.linkedin.com/in/rehanallahwala"><FontAwesomeIcon icon={faLinkedinIn}/></Link>
							<Link className="hover:cursor-pointer" href="https://twitter.com/rehanallahwala"><FontAwesomeIcon icon={faTwitter}/></Link>
							<Link className="hover:cursor-pointer" href="https://wa.me/12126559343"><FontAwesomeIcon icon={faWhatsapp}/></Link>
							<Link className="hover:cursor-pointer" href="https://didx.net/facetime:12126559343"><FontAwesomeIcon icon={faVideo}/></Link>
						</div>
					</div>
					...
					<div className="w-full relative flex flex-col items-center sm:w-2/5 xl:w-1/5">
						...
						<div className="pt-2 text-neutral-300 text-xl flex items-center gap-x-6">
							<Link className="hover:cursor-pointer" href="https://www.facebook.com/ahsansaleem87"><FontAwesomeIcon icon={faFacebookF}/></Link>
							<Link className="hover:cursor-pointer" href="https://www.linkedin.com/in/ahsansaleem87"><FontAwesomeIcon icon={faLinkedinIn}/></Link>
							<Link className="hover:cursor-pointer" href="https://twitter.com/ahsansaleem87"><FontAwesomeIcon icon={faTwitter}/></Link>
							<Link className="hover:cursor-pointer" href="https://wa.me/18503686419"><FontAwesomeIcon icon={faWhatsapp}/></Link>
							<Link className="hover:cursor-pointer" href="facetime:18503686419"><FontAwesomeIcon icon={faVideo}/></Link>
						</div>
					</div>
					...
					<div className="w-full relative flex flex-col items-center sm:w-2/5 xl:w-1/5">
						...
						<div className="pt-2 text-neutral-300 text-xl flex items-center gap-x-6">
							<Link className="hover:cursor-pointer" href="https://github.com/kamranferoz/"><FontAwesomeIcon icon={faGithub}/></Link>
							<Link className="hover:cursor-pointer" href="https://www.linkedin.com/in/kamranferoz/"><FontAwesomeIcon icon={faLinkedinIn}/></Link>
							<Link className="hover:cursor-pointer" href="https://wa.me/923352998070"><FontAwesomeIcon icon={faWhatsapp}/></Link>
						</div>
					</div>
					...
					<div className="w-full relative flex flex-col items-center sm:w-2/5 xl:w-1/5">
						...
						<div className="pt-2 text-neutral-300 text-xl flex items-center gap-x-6">
							<Link className="hover:cursor-pointer" href="https://www.facebook.com/AliDIDX"><FontAwesomeIcon icon={faFacebookF}/></Link>
							<Link className="hover:cursor-pointer" href="https://www.linkedin.com/in/Ali-DIDX"><FontAwesomeIcon icon={faLinkedinIn}/></Link>
							<Link className="hover:cursor-pointer" href="https://twitter.com/AliDIDx"><FontAwesomeIcon icon={faTwitter}/></Link>
							<Link className="hover:cursor-pointer" href="https://wa.me/12123656919"><FontAwesomeIcon icon={faWhatsapp}/></Link>
							<Link className="hover:cursor-pointer" href="facetime:12123656919"><FontAwesomeIcon icon={faVideo}/></Link>
						</div>
					</div>
					...
					<div className="w-full relative flex flex-col items-center sm:w-2/5 xl:w-1/5">
						...
						<div className="pt-2 text-neutral-300 text-xl flex items-center gap-x-6">
							<Link className="hover:cursor-pointer" href="https://www.facebook.com/aon.hyder"><FontAwesomeIcon icon={faFacebookF}/></Link>
							<Link className="hover:cursor-pointer" href="https://www.linkedin.com/in/aun-haider-96472764/"><FontAwesomeIcon icon={faLinkedinIn}/></Link>
							<Link className="hover:cursor-pointer" href="https://twitter.com/aunhaider3"><FontAwesomeIcon icon={faTwitter}/></Link>
						</div>
					</div>
					...
					<div className="w-full relative flex flex-col items-center sm:w-2/5 xl:w-1/5">
						...
						<div className="pt-2 text-neutral-300 text-xl flex items-center gap-x-6">
							<Link className="hover:cursor-pointer" href="https://www.facebook.com/UsmanDiDx"><FontAwesomeIcon icon={faFacebookF}/></Link>
							<Link className="hover:cursor-pointer" href="https://www.linkedin.com/in/usman-DIDX"><FontAwesomeIcon icon={faLinkedinIn}/></Link>
							<Link className="hover:cursor-pointer" href="https://twitter.com/usmandidx"><FontAwesomeIcon icon={faTwitter}/></Link>
							<Link className="hover:cursor-pointer" href="https://wa.me/14159120910"><FontAwesomeIcon icon={faWhatsapp}/></Link>
							<Link className="hover:cursor-pointer" href="facetime:14159120910"><FontAwesomeIcon icon={faVideo}/></Link>
						</div>
					</div>
