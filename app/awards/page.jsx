		...
		<>
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:gap-x-8">
            ...
            <div className="flex flex-col justify-start items-center">
              ...
              <Link className="bg-blue-600 text-white text-lg self-start px-3 py-1.5 mt-4 rounded" href="https://by-miconda.blogspot.com/2012/02/kamailio-2011-awards.html">View more</Link>
            </div>
          </div>
          <div className="w-full h-px bg-neutral-300 my-12 flex items-center justify-center xl:mt-4">
            <FontAwesomeIcon icon={faTrophy} className="p-3 bg-neutral-100 text-neutral-400 rounded-full"/>
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:gap-x-8">
            ...
            <div className="flex flex-col justify-start items-center">
              ...
              <Link className="bg-blue-600 text-white text-lg self-start px-3 py-1.5 mt-4 rounded" href="https://www.allworldlive.com/">View more</Link>
            </div>
          </div>
          <div className="w-full h-px bg-neutral-300 my-12 flex items-center justify-center xl:mt-4">
            <FontAwesomeIcon icon={faTrophy} className="p-3 bg-neutral-100 text-neutral-400 rounded-full"/>
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:gap-x-8">
            ...
            <div className="flex flex-col justify-start items-center">
              ...
              <Link className="bg-blue-600 text-white text-lg self-start px-3 py-1.5 mt-4 rounded" href="https://www.bbb.org/northwestern-florida/business-reviews/internet-services/super-technologies-in-pensacola-fl-13001295">View more</Link>
            </div>
          </div>
          <div className="w-full h-px bg-neutral-300 my-12 flex items-center justify-center xl:mt-4">
            <FontAwesomeIcon icon={faTrophy} className="p-3 bg-neutral-100 text-neutral-400 rounded-full"/>
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:gap-x-8">
            ...
            <div className="flex flex-col justify-start items-center">
              ...
              <Link className="bg-blue-600 text-white text-lg self-start px-3 py-1.5 mt-4 rounded" href="https://www.pr.com/press-release/350916">View more</Link>
            </div>
          </div>
          <div className="w-full h-px bg-neutral-300 my-12 flex items-center justify-center xl:mt-4">
            <FontAwesomeIcon icon={faTrophy} className="p-3 bg-neutral-100 text-neutral-400 rounded-full"/>
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:gap-x-8">
            ...
            <div className="flex flex-col justify-start items-start">
              ...
              <Link className="bg-blue-600 text-white text-lg self-start px-3 py-1.5 mt-4 rounded" href="https://www.teradata-awards.com/">View more</Link>
            </div>
          </div>
          <div className="w-full h-px bg-neutral-300 my-12 flex items-center justify-center xl:mt-4">
            <FontAwesomeIcon icon={faTrophy} className="p-3 bg-neutral-100 text-neutral-400 rounded-full"/>
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:gap-x-8">
            ...
            <div className="flex flex-col justify-start items-start">
              ...
              <Link className="bg-blue-600 text-white text-lg self-start px-3 py-1.5 mt-4 rounded" href="https://www.vision2mobile.com/">View more</Link>
            </div>
          </div>
          <div className="w-full h-px bg-neutral-300 my-12 flex items-center justify-center xl:mt-4">
            <FontAwesomeIcon icon={faTrophy} className="p-3 bg-neutral-100 text-neutral-400 rounded-full"/>
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:gap-x-8">
            ...
            <div className="flex flex-col justify-start items-start">
              ...
              <Link className="bg-blue-600 text-white text-lg self-start px-3 py-1.5 mt-4 rounded" href="https://www.digium.com/en/company/awards/innovation.php">View more</Link>
            </div>
          </div>
          <div className="w-full h-px bg-neutral-300 my-12 flex items-center justify-center xl:mt-4">
            <FontAwesomeIcon icon={faTrophy} className="p-3 bg-neutral-100 text-neutral-400 rounded-full"/>
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:gap-x-8">
            ...
            <div className="flex flex-col justify-start items-start">
              ...
              <Link className="bg-blue-600 text-white text-lg self-start px-3 py-1.5 mt-4 rounded" href="https://news.tmcnet.com/news/2007/04/30/2564473.htm">View more</Link>
            </div>
          </div>
          <div className="w-full h-px bg-neutral-300 my-12 flex items-center justify-center xl:mt-4">
            <FontAwesomeIcon icon={faTrophy} className="p-3 bg-neutral-100 text-neutral-400 rounded-full"/>
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:gap-x-8">
            ...
            <div className="flex flex-col justify-start items-start">
              ...
              <Link className="bg-blue-600 text-white text-lg self-start px-3 py-1.5 mt-4 rounded" href="https://pasha.org.pk/html_files/newsroom_news67.html">View more</Link>
            </div>
          </div>
          <div className="w-full h-px bg-neutral-300 my-12 flex items-center justify-center xl:mt-4">
            <FontAwesomeIcon icon={faTrophy} className="p-3 bg-neutral-100 text-neutral-400 rounded-full"/>
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:gap-x-8">
            ...
            <div className="flex flex-col justify-start items-start">
              ...
              <Link className="bg-blue-600 text-white text-lg self-start px-3 py-1.5 mt-4 rounded" href="https://www.tmcnet.com/usubmit/2007/09/19/2951250.htm">View more</Link>
            </div>
          </div>
          <div className="w-full h-px bg-neutral-300 my-12 flex items-center justify-center xl:mt-4">
            <FontAwesomeIcon icon={faTrophy} className="p-3 bg-neutral-100 text-neutral-400 rounded-full"/>
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:gap-x-8">
            ...
            <div className="flex flex-col justify-start items-start">
              ...
              <Link className="bg-blue-600 text-white text-lg self-start px-3 py-1.5 mt-4 rounded" href="https://www.tmcnet.com/usubmit/2007/01/03/2213308.htm">View more</Link>
            </div>
          </div>
          <div className="w-full h-px bg-neutral-300 my-12 flex items-center justify-center xl:mt-4">
            <FontAwesomeIcon icon={faTrophy} className="p-3 bg-neutral-100 text-neutral-400 rounded-full"/>
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:gap-x-8">
            ...
            <div className="flex flex-col justify-start items-start">
              ...
              <Link className="bg-blue-600 text-white text-lg self-start px-3 py-1.5 mt-4 rounded" href="https://www.apicta.com/">View more</Link>
            </div>
          </div>
          <div className="w-full h-px bg-neutral-300 my-12 flex items-center justify-center xl:mt-4">
            <FontAwesomeIcon icon={faTrophy} className="p-3 bg-neutral-100 text-neutral-400 rounded-full"/>
